...
declare module Meteor {
    ...
    interface EventHandlerFunction extends Function {
        (event?:Meteor.Event, template?: Blaze.Template):any;
    }
...
declare module Mongo {
    ...
    interface AllowDenyOptions {
        ...
        update?: (userId: string, doc: any, fieldNames: any, modifier: any) => boolean;
...
declare module DDP {
    interface DDPStatic {
        subscribe(name: any, ...rest: any[]): any;
...
declare module Meteor {
	...
	function call(name: string, ...args: any[]): void;
	...
	function publishComposite(name: string, spec: {}): void;
...
declare module Mongo {
	...
	interface Collection<T>{
		...
		remove(selector: Mongo.Selector): number;
...
interface CompileStep{
	...
	read(n?: number): any; /** TODO: add return value **/
	addHtml(options: {
				section?: string;
				data?: string;
